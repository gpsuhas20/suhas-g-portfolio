    ...
    return(
        ...
        <Navbar >
           <div className='container nav-container'>
               <div className='row'>
                   <div className='col-4'>
                        <img className='images' src={`${process.env.PUBLIC_URL}/images/suhas.png`} alt='groceries'/>
                   </div>
                   <div className='col-8'>
                   <Nav className='ml-auto nav-bar'>
                        <NavItem>
                            <h1 className='nav-head'><bold>SUHAS G</bold></h1>
                    ...
                    <div className='margin-aside'>
                        ...
                        <div className='row body'>
                            ...
                            <div className='col-10'>
                                <div>
                                    <strong><span>        </span>Florence Public School</strong> - Bangalore.
                                </div>
                                <div>
                        ...
                        <div className='row body'>
                            ...
                            <div className='col-10'>
                                <div>
                                    <strong>   Chethana</strong> - Bangalore.
                                </div>
                                <div>
           ...
           <div className='container footer'>
               <div className='row'>
                        ...
                        <div className='footer-nav'>
                           ...
                           <a href='https://github.com/gpsuhas20' className='links'><span className='fa fa-github fa-large margin-span'></span></a>
                           <a href='https://www.linkedin.com/in/suhas-garla-80746916b/' className='links'><span className='fa fa-linkedin-square fa-large margin-span'></span></a>
                           <a href='https://www.instagram.com/suhas_garla/' className='links'><span className='fa fa-instagram fa-large margin-span'></span></a>
                            </div>
                        </div>
